...
public class ControlDeStockFrame extends JFrame {
	...
	private void modificar() {
		...
		Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
				.ifPresentOrElse(fila -> {
					...
					Producto producto = new Producto(nombre, descripcion, cantidad, id);
					...
					JOptionPane.showMessageDialog(this, filasModificadas + " item modificado");
				}, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
	}
	...
	private void eliminar() {
		...
		Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
				.ifPresentOrElse(fila -> {
					...
					int itemsEliminados = this.productoController.eliminar(id);
	...
	private void cargarTabla() {
		var listaProductos = this.productoController.listar();
